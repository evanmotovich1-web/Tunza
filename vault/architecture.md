...
- `components/` — the seven contract components + HomeScreen, CareShell,
  DemoChrome (demo harness: role switcher, failure injection, language toggle,
  start over; wordmark navigates home for household).
